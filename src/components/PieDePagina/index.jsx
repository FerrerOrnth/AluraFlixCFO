        ...
        <Footer>
            <FooterContenido>
                <FooterDiv>
                    ...
                    Desarrollado con <FavoriteBorderOutlinedIcon sx={{ color: 'red' }}/> y <LocalFireDepartmentOutlinedIcon sx={{ color: 'orange' }}/> por <LinkExterno href="https://ferrerornth.github.io/portfolioCFO/" target="__blank">Claudio Ferrer Ornth</LinkExterno>
                    </ContenedorTextoFooter>
                </FooterDiv>
            </FooterContenido>
        </Footer>
